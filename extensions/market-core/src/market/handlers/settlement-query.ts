  ...
  return (opts: GatewayRequestHandlerOptions) => {
    ...
    try {
      ...
      respond(true, {
        ...
        paymentChain: settlement.paymentChain ?? null,
        paymentNetwork: settlement.paymentNetwork ?? null,
        paymentIntentId: settlement.paymentIntentId ?? null,
        paymentReceiptId: settlement.paymentReceiptId ?? null,
        paymentTxHash: settlement.paymentTxHash ?? null,
        paymentConfirmedAt: settlement.paymentConfirmedAt ?? null,
        confirmationStatus: settlement.confirmationStatus ?? null,
        fxQuoteId: settlement.fxQuoteId ?? null,
        treasuryRouteId: settlement.treasuryRouteId ?? null,
