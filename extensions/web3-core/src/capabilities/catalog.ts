...
export function describeWeb3Capabilities(
  ...
  const capabilities: CapabilityDescriptor[] = [
    ...
    },
    {
      ...
      returns: "Lease issuance result (token is stored internally and not returned).",
      risk: {
        level: "high",
    ...
    },
    {
      ...
      paramsSchema: {
        ...
        properties: {
          limit: {
            type: "number",
            description: "Max peers to return",
            minimum: 1,
            maximum: 500,
          },
        },
    ...
    },
    {
      ...
      group: "monitor",
      availability: availability(true),
      paramsSchema: { alertId: "string", resolvedBy: "string", resolutionNote: "string" },
    ...
    },
    {
      ...
      paramsSchema: {
        ...
        properties: {
          status: {
            type: "string",
            enum: ["token_draft", "token_active", "token_paused"],
          },
          policy: {
            type: "object",
            required: ["symbol"],
            properties: {
              ...
              burn: {
                type: "object",
                properties: {
                  burnRateBps: { type: "number", minimum: 0, maximum: 10000 },
                },
              },
              governance: {
                type: "object",
