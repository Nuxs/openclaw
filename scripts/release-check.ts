...
const requiredPathGroups = [
  ...
  "dist/plugin-sdk/gateway-types.js",
  "dist/plugin-sdk/gateway-types.d.ts",
  "dist/plugin-sdk/plugin-definition.js",
  "dist/plugin-sdk/plugin-definition.d.ts",
  "dist/plugin-sdk/plugin-command.js",
  "dist/plugin-sdk/plugin-command.d.ts",
  "dist/plugin-sdk/plugin-hooks.js",
  "dist/plugin-sdk/plugin-hooks.d.ts",
  "dist/plugin-sdk/ssrf.js",
  "dist/plugin-sdk/ssrf.d.ts",
  "dist/plugin-sdk/http-body.js",
  "dist/plugin-sdk/http-body.d.ts",
  "dist/plugin-sdk/http-route.js",
  "dist/plugin-sdk/http-route.d.ts",
  "dist/plugin-sdk/config-types.js",
  "dist/plugin-sdk/config-types.d.ts",
