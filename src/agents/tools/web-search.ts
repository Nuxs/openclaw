...
function resolveWebSearchDescription(
  provider: (typeof SEARCH_PROVIDERS)[number],
  options?: { perplexitySchemaTransportHint?: string; braveMode?: "web" | "llm-context" },
): string {
  ...
  if (provider === "perplexity") {
    return options?.perplexitySchemaTransportHint === "chat_completions"
  ...
  return options?.braveMode === "llm-context"
