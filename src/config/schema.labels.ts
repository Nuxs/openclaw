...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.searxng.rerank.mode": "SearxNG Rerank Mode",
  "tools.web.search.searxng.rerank.endpoint": "SearxNG Rerank Endpoint",
  "tools.web.search.searxng.rerank.timeoutSeconds": "SearxNG Rerank Timeout (sec)",
  "tools.web.search.searxng.rerank.maxCandidates": "SearxNG Rerank Max Candidates",
  "tools.web.search.searxng.rerank.maxLength": "SearxNG Rerank Max Length",
