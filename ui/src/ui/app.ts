...
export class OpenClawApp extends LitElement {
  ...
  @state() chatProgress: ChatProgressState | null = null;
  ...
  @state() marketAuditSnapshot: import("./types.js").MarketAuditSnapshot | null = null;
  @state() marketAuditError: string | null = null;
