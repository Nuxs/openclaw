...
// ── Web3 / Market types (extracted to types-web3.ts) ────────────────
export type {
  BridgeRoute,
  ...
  MarketAuditMetrics,
  MarketDispute,
  MarketDisputeMetrics,
  MarketDisputeSort,
  MarketDisputeStatus,
  MarketDetectedProvider,
  MarketPresetIntent,
  MarketPresetMode,
  ...
  MarketResourceStatusFilter,
  MarketRevocationMetrics,
  MarketSettlementMetrics,
  MarketStatusSummary,
  OpsAlertView,
  OpsHealthProbe,
  PrivacyAssetView,
